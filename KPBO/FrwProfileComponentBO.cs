...
namespace KPBO 
{
    ...
    /// </summary>
    public class FrwProfileComponentBO : BaseBO<FrwProfileComponent>
    {
        public FrwProfileComponentBO(FrwProfileComponent entity)
            : base(entity)
        {
        ...
        public override FrwProfileComponent SaveEntity()
        {
            // Your code here

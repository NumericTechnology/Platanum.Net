...
namespace KPComponents
{
    ...
    /// </summary>
    public class KPFormItemTextControl : KPFormItemControlBase<KPFormItemText>
    {
        private string ControlFieldID;
        private string ControlLabelID;

        public override KPFormItemText FormItem
        {
            get;
            protected set;
        }
        ...
        public KPFormItemTextControl(KPFormBaseControl formControl, KPFormItemText formItem, object objValue)
            : base(formControl)
        {
            this.ID = formItem.ID;
        ...
        protected override void CreateChildControls()
        {
            ...
            string classMask = FormItem.Mask.GetTypeValue().ToString();
            ...
            if (FormItem.MultiLine)
            {
                kpTextBoxField.TextMode = TextBoxMode.MultiLine;
                kpTextBoxField.Height = FormItem.Height;
            }
